    ...
    >
      ...
      >
        ...
        <div className="w-full h-[55px] border-2 border-white bg-transparent text-white rounded-full relative flex items-center">
          ...
          {!showPassword ? (
            <IoEye
              className="absolute right-5 w-6 h-6 text-white cursor-pointer hover:scale-110 transition"
        ...
        {err.length > 0 && (
          <p className="text-red-400 text-[16px] font-medium">*{err}</p>
        )}

        <button
          className="min-w-[160px] h-[55px] mt-4 bg-gradient-to-r from-blue-400 to-purple-500 text-white font-semibold rounded-full text-[18px] shadow-lg hover:shadow-[0_0_20px_#60a5fa] transition disabled:opacity-70"
          disabled={loading}
        >
        ...
        <p
          className="text-white text-[16px] mt-4 cursor-pointer hover:underline"
